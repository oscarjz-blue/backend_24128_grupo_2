...
const createMovie = (req, res) => {
    ...
    const sql = 'INSERT INTO favoritos (title, director, year, image) VALUES (?, ?, ?, ?)'
    db.query(sql, [title, director, year, image], (err, results) => {
        ...
        res.json({ message: 'favoritos created', movieId: results.insertId })
    })
}
...
const updateMovie = (req, res) => {
    ...
    const sql = 'UPDATE favoritos SET title = ?, director = ?, year = ?, image = ? WHERE id = ?'
    db.query(sql, [title, director, year, image, id], (err, result) => {
        ...
        res.json({ message: 'favoritos updated' })
    })
}
...
const deleteMovie = (req, res) => {
    ...
    db.query(sql, [id], (err, result) => {
        ...
        res.json({ message: 'favoritos deleted' })
    })
}
